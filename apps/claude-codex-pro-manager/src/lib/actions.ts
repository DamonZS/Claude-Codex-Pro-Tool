...
export function createActionsShape() {
  return {
    ...
    refreshMemoryOutcomeDashboard: async (_rangeDays?: number, _silent?: boolean) => null as MemoryOutcomeDashboardResult | null,
    loadMemoryNewProjectGuide: async () => null as MemoryNewProjectGuideResult | null,
