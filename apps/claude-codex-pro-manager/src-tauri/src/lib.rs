...
pub fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::inspect_leila_status,
            commands::choose_leila_codex_target,
            commands::deploy_leila,
            commands::rollback_leila,
            commands::list_client_deploy_targets,
            commands::deploy_prompt_to_clients,
            commands::restore_client_deploy,
            commands::fetch_prompt_index,
            commands::fetch_prompt_content,
            commands::compose_prompt_sources,
            commands::install_tool_package,
            commands::remove_tool_package,
            commands::read_local_prompt,
            commands::install_skills_to_clients,
            commands::remove_installed_skills,
