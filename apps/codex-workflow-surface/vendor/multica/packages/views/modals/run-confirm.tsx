/* CCP modification: Accept verified native handoff capability without a synthetic CLI version. Upstream attribution: vendor/multica/NOTICE. */
"use client";
...
export function RunConfirmModal({
  ...
  const localHandoff = useMemo<boolean | null>(() => {
    ...
    return runtime.metadata?.nativeHandoffSupported === true || handoffSupported(readRuntimeCliVersion(runtime.metadata));
