/* CCP modification: Gate quick create on native task-host capability without a synthetic CLI version. Upstream attribution: vendor/multica/NOTICE. */
"use client";
...
export function AgentCreatePanel({
  ...
  const versionBlocked = quickCreateVersionBlocked(selectedRuntime?.metadata, usesExplicitFields);
