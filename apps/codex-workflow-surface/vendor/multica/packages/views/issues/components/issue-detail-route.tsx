/* CCP modification: Forward the embedded host return control through detail, loading and not-found states. Upstream attribution: vendor/multica/NOTICE. */
"use client";
 ...
 */
export function IssueDetailRoute({ routeId, onDelete, leadingAction }: IssueDetailRouteProps) {
  ...
  if (notFound || !canonicalId) return <IssueNotFound showBackLink={!onDelete && !leadingAction} leading={leadingAction} />;
