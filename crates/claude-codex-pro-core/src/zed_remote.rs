...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read Claude Codex Pro Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse Claude Codex Pro Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write Claude Codex Pro Zed remote project registry")]
